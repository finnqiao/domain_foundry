"""hermes-agent adapter for the domain_expert harness.

Exposes the harness runtime surface (capture / query / correct / review /
new_domain) as hermes-agent tools that talk to a running ``domain-expert serve``
...
from domain_expert_hermes_agent.client import DomainExpertClient, DomainExpertError

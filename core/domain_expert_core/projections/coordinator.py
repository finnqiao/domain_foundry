...
from domain_expert_core.clock import now, now_iso
...
class ProjectionCoordinator:
    ...
    def _default_adapters(self) -> dict[str, ProjectionAdapter]:
        ...
        from domain_expert_core.projections.blockdata import BlockDataAdapter
        from domain_expert_core.projections.markdown import MarkdownAdapter

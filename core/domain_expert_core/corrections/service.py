...
from domain_expert_core.corrections.intent import (
    ParsedCorrection,
    has_correction_intent,
    parse_correction_text,
)
from domain_expert_core.interpret.fewshot import append_eval_case, rebuild_fewshot_bank
from domain_expert_core.packs.registry import PackRegistry
from domain_expert_core.paths import Workspace
from domain_expert_core.routing.l1 import L1Matcher
...
class CorrectionService:
    ...
    def _undo(
        ...
        conn = connect_rw(self.ws.ledger_db)
        try:
            from domain_expert_core.apply.journal import write_change_request_result
